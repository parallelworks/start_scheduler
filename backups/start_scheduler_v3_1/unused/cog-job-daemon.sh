...
# Optional:
cpe=$7 # Cores per executor
sched_licenses=$8 # Licenses per scheduler
...
cjs() {
    ...
    wait_till_iddle_map="${apps_dir}/wti.sh -> ${exec_work_dir}/wti.sh : ${apps_dir}/get_executors.py -> ${exec_work_dir}/get_executors.py"
